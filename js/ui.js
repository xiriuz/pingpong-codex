...
export class UI{
  ...
  serve(show,stage,firstPoint){const guide=document.querySelector('#serve-guide'),help=document.querySelector('#start-help');guide.classList.toggle('show',show);guide.textContent=stage===0?'③ 오른쪽 노란 안내를 톡!':'좋아! 오른쪽을 한 번 더 톡! 🏓';help.classList.toggle('show',show&&firstPoint);help.querySelector('.help-hit strong').textContent=stage===0?'여기를 톡!':'한 번 더 톡!';}
